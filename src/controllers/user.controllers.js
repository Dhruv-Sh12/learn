...
const registerUser = asyncHandler( async (req, res) => {
    ...
    if (!avatar || avatar.error) {
        console.error("Error uploading avatar to Cloudinary:", avatar.error);
...
const loginUser=asyncHandler(async(req,res)=>{
    ...
    if(!(username || email)){
        throw new ApiError(400, "Email or Username not provided")
    }
   ...
   return res
    ...
    .json(
        new ApiResponse(
            200, 
            {
                user: loginUser, acessToken, refreshToken
            },
